...
<body>
    ...
    <div class="content" id="about">
        <h2>About Us</h2>
        <p>Welcome to MML Studios website we make music for you to buy use share and much more we strive for great experince  and hope to have you on our jounery.</p>
    </div>
